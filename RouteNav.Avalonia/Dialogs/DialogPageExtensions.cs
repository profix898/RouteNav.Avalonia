...
{
    public static Task<object?> PushDialogAsync(this INavigationStack stack, Page page, bool forceOverlay = false)
    {
        return stack.PushDialogAsync(page.ToDialog(stack.CurrentPage), forceOverlay);
    }
