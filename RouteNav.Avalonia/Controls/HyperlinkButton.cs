...
using Controls_HyperlinkButton = Avalonia.Controls.HyperlinkButton;
...
public class HyperlinkButton : Button, IRouteItem
{
    ...
    /// </summary>
    public static readonly StyledProperty<Uri?> RouteUriProperty = AvaloniaProperty.Register<HyperlinkButton, Uri?>(nameof(RouteUri));

    /// <summary>
    /// Defines the <see cref="TargetProperty" /> property.
    /// </summary>
    public static readonly StyledProperty<NavigationTarget> TargetProperty = AvaloniaProperty.Register<HyperlinkButton, NavigationTarget>(nameof(Target));

    /// <summary>
    /// Defines the <see cref="IsVisited" /> property.
    /// </summary>
    public static readonly StyledProperty<bool> IsVisitedProperty = AvaloniaProperty.Register<HyperlinkButton, bool>(nameof(IsVisited));

    /// <summary>
    /// Defines the <see cref="TrackIsVisited" /> property.
    /// </summary>
    public static readonly StyledProperty<bool> TrackIsVisitedProperty = AvaloniaProperty.Register<HyperlinkButton, bool>(nameof(TrackIsVisited));
    ...
    /// <br></br>
    /// For compatibility with both V11.1 <see cref="Avalonia.Controls.HyperlinkButton" /> and <see cref="IRouteItem" /> (in this library), both <see cref="RouteUri" /> and
    /// <see cref="NavigateUri" /> are provided. Use any one of them.
    /// </remarks>
    ...
    /// <inheritdoc />
    protected override Type StyleKeyOverride => typeof(Controls_HyperlinkButton);
